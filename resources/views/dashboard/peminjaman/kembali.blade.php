...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="mb-2 row">
                <div class="col-sm-6">
                    <h1 class="m-0">Konfirmasi Pengembalian</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('dashboard.peminjaman.update', $invoice->invoice) }}" method="POST"
                    ...
                    <p>Tenggat Peminjaman: <span class="font-weight-bold">{{ $invoice->tenggat_pinjam }}</span></p>
                    <div class="mb-3 w-100">
                        <label for="kembali" class="form-label">Tanggal Dikembalikan</label>
                        <input type="date" name="tgl_kembali" id="kembali" class="form-control">
                    </div>
                    <div class="mb-3 w-100">
                        <label for="status" class="form-label">Status Peminjaman</label>
                        <select class="custom-select" name="status">
                            <option selected>Ubah Status</option>
                            <option value="pinjam" {{ $invoice->status == 'pinjam' ? 'selected' : '' }}>dipinjam</option>
                            <option value="kembali" {{ $invoice->status == 'kembali' ? 'selected' : '' }}>dikembalikan</option>
                        </select>
                    </div>
