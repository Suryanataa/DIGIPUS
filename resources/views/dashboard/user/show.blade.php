            ...
            <div class="card-body">
                ...
                <div class="flex-row d-flex " style="gap: 1rem">
                    ...
                    <div class="mb-3 input-group d-flex flex-column ">
                        ...
                        <textarea name="alamat" readonly placeholder="tempat tinggal" class="form-control w-100" id="alamat" cols="30"
                ...
                <div class="mb-3 w-100">
                    ...
                    <select disabled class="custom-select" name="role">
