...
@section('content')
    <div class="px-[100px] mt-20">
        ...
        @if ($koleksi->count() == 0)
            <img src="/images/illus-read.png" alt="illustrasi" class="mx-auto" width="350">
                    ...
                    <div
                        ...
                        <form action="{{ route('koleksi.destroy', $item->id) }}" method="post">
                            ...
                            <div class="flex flex-col gap-3">
                                <button type="submit"
                                    class="py-3 text-white rounded-md px-7 bg-primary hover:bg-secondary">hapus
                                    koleksi</button>
                                <a href="{{ route('buku.detail', $item->buku->slug) }}"
                                    class="w-full py-3 text-center border-2 rounded-md px-7 border-primary hover:bg-primary hover:text-white">lihat
                                    buku</a>
                            </div>
                        </form>
                    </div>
